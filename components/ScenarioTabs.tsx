...
export function ScenarioTabs() {
  ...
  return (
    <section className="shell-card overflow-hidden rounded-[2.2rem] p-5 md:p-6">
      <div className="mb-5 flex flex-col justify-between gap-4 md:flex-row md:items-center">
        <div>
          <p className="text-xs font-black uppercase tracking-[0.3em] text-[#f2b84b]">4-tab showcase</p>
          <h3 className="mt-2 text-2xl font-black tracking-tight">Security scene switcher</h3>
        </div>
      ...
      <motion.div
        ...
        className="relative overflow-hidden rounded-[1.9rem] border border-white/10 bg-[#0d0d0c] p-5 md:p-7"
      >
        ...
        <div className="relative z-10 grid gap-6 lg:grid-cols-[1fr_240px] lg:items-end">
          <div>
            ...
            <h4 className="max-w-2xl text-3xl font-black leading-tight tracking-[-0.04em] md:text-5xl">{scenario.title}</h4>
          ...
          <div className="group relative min-h-64 overflow-hidden rounded-[1.6rem] bg-[#f2b84b] p-4 text-black shadow-[0_26px_80px_rgba(242,184,75,.2)]">
            <div className="absolute inset-x-6 top-5 h-20 rounded-full bg-white/35 blur-2xl" />
            <div className="relative z-10 flex h-full flex-col justify-between">
              <div>
                <p className="text-xs font-black uppercase tracking-[0.25em]">hover card</p>
              ...
              <div className="rounded-2xl bg-black p-4 text-stone-50 transition group-hover:-translate-y-2">
                ...
                <p className="text-sm font-bold">Pop-up detail appears on hover in the real UI.</p>
              </div>
            </div>
            <span className="absolute right-4 top-4 rounded-full bg-black px-3 py-1 text-xs font-black text-[#f2b84b] opacity-0 transition group-hover:opacity-100">visual tooltip</span>
          </div>
        </div>
      </motion.div>
    </section>
