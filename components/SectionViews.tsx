...
function SectionShell({
  ...
  return (
    <div className="mx-auto w-full max-w-7xl space-y-5 pt-4 sm:pt-5 2xl:space-y-6">
      <section className="relative overflow-hidden rounded-[1.8rem] border border-white/10 bg-[#161614]/90 p-5 shadow-[0_28px_90px_rgba(0,0,0,.36)] sm:p-6 lg:p-7">
        ...
        <div className="relative z-10 grid gap-5 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-end">
          <div className="min-w-0">
            ...
            <h2 className="mt-3 max-w-4xl text-[clamp(2.3rem,6vw,5.2rem)] font-black leading-[0.93] tracking-[-0.07em] text-stone-50">
              {title}
            </h2>
  ...
  return (
    ...
    >
      <div className="grid gap-5 xl:grid-cols-[minmax(0,1.05fr)_390px]">
        <section className="rounded-[1.7rem] border border-white/10 bg-[#151513] p-4 shadow-[0_24px_70px_rgba(0,0,0,.26)] sm:p-5">
            ...
            {filteredIncidents.map((incident) => {
              ...
              return (
                <button
                  ...
                  className={`group grid gap-4 rounded-[1.35rem] border p-4 text-left transition md:grid-cols-[110px_minmax(0,1fr)_110px] md:items-center ${
                    selected
        ...
        <aside className="grid gap-5">
          <div className="rounded-[1.7rem] border border-white/10 bg-[#10100f] p-5">
              ...
              {attackSources.map((source) => (
                <div key={source.country}>
                  ...
                  <div className="h-2 overflow-hidden rounded-full bg-white/[0.08]">
                    <div className="h-full rounded-full bg-[#f2b84b]" style={{ width: `${source.value}%` }} />
                  </div>
                </div>
              ))}
            </div>
  ...
  return (
    ...
    >
      <div className="grid gap-5 xl:grid-cols-[390px_minmax(0,1fr)]">
        <section className="rounded-[1.7rem] border border-white/10 bg-[#151513] p-5">
          ...
          <div className="mt-5 space-y-4">
            {controls.map((control) => (
              <div key={control.name} className="rounded-2xl border border-white/10 bg-black/25 p-4">
                ...
                <div className="h-2 overflow-hidden rounded-full bg-white/[0.08]">
                  <div className="h-full rounded-full bg-gradient-to-r from-[#f2b84b] to-emerald-300" style={{ width: `${control.score}%` }} />
                </div>
              </div>
            ))}
          </div>
            ...
            {integrations.map((asset) => {
              ...
              return (
                <button
                  ...
                  className={`min-w-0 rounded-[1.45rem] border p-4 text-left transition ${
                    selected
                      ? "border-[#f2b84b]/45 bg-[#f2b84b]/10"
  ...
  return (
    ...
    >
      <div className="grid gap-5 xl:grid-cols-[420px_minmax(0,1fr)]">
        ...
        <section className="rounded-[1.7rem] border border-white/10 bg-[#10100f] p-5 sm:p-6">
          <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_300px] lg:items-start">
            <div>
              ...
              <h3 className="mt-4 text-[clamp(2rem,5vw,4rem)] font-black leading-[0.96] tracking-[-0.06em] text-stone-50">
                {playbook.title}
              </h3>
