  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#11110f] text-stone-50">
      ...
      <div className="mx-auto flex min-h-screen w-full max-w-[1600px]">
        ...
        <section className="relative min-w-0 flex-1 px-3 pb-10 pt-3 sm:px-4 md:px-6 lg:h-screen lg:overflow-y-auto lg:px-8 lg:pb-16 lg:pt-4">
          <MainNav />
          <div className="mx-auto max-w-7xl space-y-5 pt-5 md:space-y-6">
            <CommandHero />
            <AlertStream />
            <DefenseCards />
            <div className="grid gap-5 xl:grid-cols-[1.06fr_.94fr] xl:gap-6">
              <ScenarioTabs />
              <HoverLab />
            </div>
          </div>
